...
line_node node_w, node_l, node_t, node_c, node_lt, node_wt, node_wl;
line_hin hin_ww, hin_ll, hin_tt, hin_wl, hin_lt, hin_tw, hin_lw, hin_tl, hin_wt,\
         hin_cl, hin_ct, hin_cw, hin_lc, hin_tc, hin_wc, \
         hin_wlt, hin_lwt, hin_twl;
line_trainer_edge trainer_edge_ww, trainer_edge_ll, trainer_edge_tt, \
                  trainer_edge_wl, trainer_edge_lt, trainer_edge_tw, trainer_edge_lw, trainer_edge_tl, trainer_edge_wt, \
                  trainer_edge_cl, trainer_edge_ct, trainer_edge_cw, trainer_edge_lc, trainer_edge_tc, trainer_edge_wc, \
                  trainer_edge_wlt, trainer_edge_lwt, trainer_edge_twl;
...
void *training_thread(void *id)
{
    ...
    while (1)
    {
        ...
        trainer_edge_wlt.train_sample(alpha, error_vec, func_rand_num, next_random, second_order);
        trainer_edge_lwt.train_sample(alpha, error_vec, func_rand_num, next_random, second_order);
        trainer_edge_twl.train_sample(alpha, error_vec, func_rand_num, next_random, second_order);        
...
void TrainModel() {
    ...
    char node_file_lt[MAX_STRING]="node-lt-", node_file_wt[MAX_STRING]="node-wt-", node_file_wl[MAX_STRING]="node-wl-";  
    ...
    char link_file_wlt[MAX_STRING]="edge-wlt-",link_file_lwt[MAX_STRING]="edge-lwt-",link_file_twl[MAX_STRING]="edge-twl-";    
    ...
    node_lt.init(node_file_lt, vector_size, job_id);
    node_wt.init(node_file_wt, vector_size, job_id);
    node_wl.init(node_file_wl, vector_size, job_id);
    ...
    hin_wlt.init(link_file_wlt, &node_w, &node_lt, job_id);
    hin_lwt.init(link_file_lwt, &node_l, &node_wt, job_id);
    hin_twl.init(link_file_twl, &node_t, &node_wl, job_id);
    ...
    trainer_edge_wlt.init('e', &hin_wlt, negative);
    trainer_edge_lwt.init('e', &hin_lwt, negative);
    trainer_edge_twl.init('e', &hin_twl, negative);
